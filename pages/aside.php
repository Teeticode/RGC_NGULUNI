...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($_SERVER['REQUEST_URI'] === "/RGC-DASHBOARD/pages/profile.php" || $_SERVER['REQUEST_URI'] === "/RGC-DASHBOARD/pages/change-profile.php"){
                                      echo 'active';   
                                    }      
        ...
        ?>
        <li class='nav-item'>
          <a class='nav-link  <?php if($_SERVER['REQUEST_URI'] === '/RGC-DASHBOARD/pages/sign-in.php'){
                                      echo 'active';   
                                    }      
